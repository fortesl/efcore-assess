namespace Fortes.Assess.WebApi.Controllers
{
    ...
    public class QuestionsController : BaseController
    {
        ...
        public QuestionsController(IRepository<Question> repo, ILogger<QuestionsController> logger, IHttpContextAccessor context)
        {
            ...
            _repo = repo ?? throw new ArgumentNullException($"Question repository is not defined!");
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            if (question == null)
            {
                _logger.LogError($"Get: question {id} not found");
                return NotFound();
            }
            return Ok(question);
        }
        ...
        public async Task<IActionResult> Delete([FromRoute] int id)
        {
            ...
            var deleted = await _repo.DeleteAsync(new Question{ Id = id});
            if (deleted == null)
            {
